...
test("Create news with non-valid title", {tag: ["@negative", "@regression"]},
                                                  async ({ newsClient }) => {
...
test("Create news with non-valid content", {tag: ["@negative", "@regression"]},
                                                  async ({ newsClient }) => {
...
test("Create news with non-valid tags", {tag: ["@negative", "@regression"]},
                                                  async ({ newsClient }) => {
